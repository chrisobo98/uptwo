        ...
        <div class="flex flex-col items-center md:flex-row gap-8">
          <div class="w-full xl:w-1/2">
            <div
              ...
              class="bg-white shadow-sm rounded-2xl p-8 mt-14 md:mt-0"
            >
              <div
              ...
              <p class="py-6 text-lg leading-8 text-gray-400">
                "Working with upTWo Consulting has been a game-changer for Elite
                Children's Learning Center. His strategic brand approach,
                innovative ideas, and project management skills exceeded my
                expectations and kept him on retainer for far longer than I
                initially anticipated. Beyond crafting impactful copy for our
                curriculum, his brand messaging strategies created a seamless
                flow among employees, reconnected us with parents, and fostered
                a safe, loving, and professional environment. His solutions
                didn't just elevate our brand — they expanded our franchise in
          ...
          <div class="w-full xl:w-1/2 grid gap-8">
            <div
              v-gsap.parallax.faster-8
              class="bg-white shadow-sm rounded-2xl p-8"
            >
              <div
                class="flex items-center gap-2 text-amber-500 transition-all duration-500"
              >
              ...
              <p class="py-6 text-lg leading-8 text-gray-400">
                ...
                customer flow with new to-go signs and posters. We saw smoother
                traffic, increased sales, and happier customers within a week.
            ...
            >
              ...
              <p class="py-6 text-lg leading-8 text-gray-400">
                ...
                person we knew could deliver — T. Alexander. Having worked with
                him in the past, we knew his strategic mind and...
