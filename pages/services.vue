    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div v-gsap.visible.from="{ opacity: 0, y: 50, stagger: 0.4 }" class="text-center mb-10">
        ...
        <p class="text-lg text-gray-400">
          We pride ourselves on delivering tailored services to meet diverse needs,
          from strategic consulting and creative solutions to robust marketing.
        </p>
      </div>
      ...
      <div class="lg:pt-10 pt-8 min-h-[32rem]">
        <div v-for="tab in tabs" :key="tab.id" v-show="activeTab === tab.id" class="grid lg:grid-cols-2 gap-8"
          ...
          <img :src="tab.image" alt="Feature image" class="mx-auto max-h-72 w-full object-cover rounded-3xl"
            ref="tabImage">
          ...
          <div class="flex flex-col gap-6 py-6" ref="tabText">
            ...
            <ul class="flex flex-col gap-3">
              <li v-for="feature in tab.features" :key="feature.title" class="flex gap-3 items-center">
                ...
                <div>
                  <h6 class="text-white text-sm font-medium">{{ feature.title }}</h6>
