<template>
    <div>
        <section class="pt-5 lg:pt-20 overflow-x-hidden">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-14 items-center lg:grid-cols-12 lg:gap32">
                        <div class="w-full xl:col-span-5 lg:col-span-6">
                            ...
                            <p class="text-gray-400 text-base text-center mb-10 lg:text-left">
                        ...
                        <div class="w-5/6 mx-auto xl:col-span-7 lg:col-span-6">
                            <img src="//img1.wsimg.com/isteam/ip/aadf6fc8-f522-4009-80bc-3b540e85f52b/suave%20edited.jpg/:/cr=t:1.68%25,l:0%25,w:100%25,h:93.13%25"
                                alt="Portfolio Image" class="w-full lg:h-auto rounded-3xl object-cover" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="md:w-3/4 bg-cover bg-center mx-auto rounded-2xl">
                <section class="mx-auto lg:pt-[84px] pb-12">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="swiper-container slider w-full flex-col justify-start items-start gap-12">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide" v-for="(slide, index) in slides" :key="index">
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <img class="h-auto w-auto object-cover md:mt-24 rounded-lg " :src="slide.img"
                        ...
                        <div class="swiper-container slider-thumbnail relative mt-20">
                            <div class="swiper-wrapper lg:flex-row flex-col">
                                ...
                                }" v-for="(slide, index) in slides" :key="index" @click="goToSlide(index)">
                                    <div class="text-lg font-normal leading-relaxed whitespace-nowrap">
                                        {{ index + 1 }}. {{ slide.thumbnail }}
                                    </div>
                                    <div v-show="activeIndex === index" class="swiper-scrollbar my-12"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h1 class="py-8 text-center text-white font-extrabold font-manrope text-5xl lg:text-right">
                    Storytelling <span class="text-yellow-600">Visuals</span>
                </h1>
            </div>

            <!-- Swiper2 Section -->
            <div class="md:w-3/4 bg-no-repeat bg-cover bg-center mx-auto rounded-2xl"
                ...
                <section class="mx-auto lg:pt-[84px] pb-12">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide" v-for="(slide, index) in slides2" :key="index">
                                    <div class="grid grid-cols-2 gap-4">
                                        <img class="h-auto w-auto object-cover md:mt-24 rounded-lg " :src="slide.img"
                                            alt="image description">
                                    <div class="w-full flex-col justify-end items-end gap-8 flex text-right">
                                        <div class="flex flex-col">
                                            <h2
                        ...
                        <div class="swiper-container slider-thumbnail2 relative flex justify-end mt-20">
                            <div class="swiper-wrapper lg:flex-row flex-col">
                                ...
                                }" v-for="(slide, index) in slides2" :key="index" @click="goToSlide2(index)">
                                    <div class="text-lg font-normal leading-relaxed whitespace-nowrap">
                                         {{ slide.thumbnail }}
                                    </div>
                                    <div v-show="activeIndex2 === index" class="swiper-scrollbar my-12"></div>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex justify-center items-center gap-y-8 md:gap-y-0 flex-wrap md:flex-wrap xl:flex-nowrap xl:flex-row xl:justify-between xl:gap-x-8 max-w-lg md:max-w-3xl lg:max-w-4xl mx-auto xl:max-w-full">
            <div class="w-full xl:w-1/3">
                <span class="text-sm text-yellow-600 font-medium mb-4 block">Brand Strategist Testimonials</span>
                ...
                <div class="flex flex-col items-center md:flex-row gap-8">
                    <div class="w-full xl:w-1/2">
                        <div class="bg-white shadow-sm rounded-2xl p-8">
                            <div class="flex items-center gap-2 text-amber-500 transition-all duration-500  ">
                            ...
                            <p class="py-6 text-lg leading-8 text-gray-400">"Working with upTWo Consulting has been a game-changer for Elite Children's Learning Center. His strategic brand approach, innovative ideas, and project management skills exceeded my expectations and kept him on retainer for far longer than I initially anticipated. Beyond crafting impactful copy for our curriculum, his brand messaging strategies created a seamless flow among employees, reconnected us with parents, and fostered a safe, loving, and professional environment. His solutions didn't just elevate our brand — they expanded our franchise in ways I hadn’t imagined."</p>
                            <div class="flex items-center">
                                <div class="flex items-center gap-4">
                                    <img src="https://pagedone.io/asset/uploads/1704349534.png" alt="Emily image" class="w-6 h-6 rounded-full object-cover"/>
                                    <h6 class="font-medium text-white">C.E.O., Founder</h6>
                                </div>
                                <span class="text-sm font-medium text-yellow-600 ml-4 pl-4 border-l border-solid border-gray-300">Elite Children Learning Center</span>
                            </div>
                        </div>
                    </div>
                    <div class="w-full xl:w-1/2 grid gap-8">
                        <div class="bg-white shadow-sm rounded-2xl p-8">
                            <div class="flex items-center gap-2 text-amber-500 transition-all duration-500  ">
                                <svg class="w-5 h-5" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.10326 1.31699C8.47008 0.57374 9.52992 0.57374 9.89674 1.31699L11.7063 4.98347C11.8519 5.27862 12.1335 5.48319 12.4592 5.53051L16.5054 6.11846C17.3256 6.23765 17.6531 7.24562 17.0596 7.82416L14.1318 10.6781C13.8961 10.9079 13.7885 11.2389 13.8442 11.5632L14.5353 15.5931C14.6754 16.41 13.818 17.033 13.0844 16.6473L9.46534 14.7446C9.17402 14.5915 8.82598 14.5915 8.53466 14.7446L4.91562 16.6473C4.18199 17.033 3.32456 16.41 3.46467 15.5931L4.15585 11.5632C4.21148 11.2389 4.10393 10.9079 3.86825 10.6781L0.940384 7.82416C0.346867 7.24562 0.674378 6.23765 1.4946 6.11846L5.54081 5.53051C5.86652 5.48319 6.14808 5.27862 6.29374 4.98347L8.10326 1.31699Z" fill="currentColor"></path>
                            ...
                            <p class="py-6 text-lg leading-8 text-gray-400">"Thanks to their strategic brand messaging, we transformed our customer flow with new to-go signs and posters. We saw smoother traffic, increased sales, and happier customers within a week. It was an instant success!"</p>
                            <div class="flex items-center">
                                <div class="flex items-center gap-4">
                                    <img src="https://pagedone.io/asset/uploads/1704349514.png" alt="Olivia image" class="w-6 h-6 rounded-full object-cover"/>
                                    <h6 class="font-medium text-white">Co-Founder</h6>
                                </div>
                                <span class="text-sm font-medium text-yellow-600 ml-4 pl-4 border-l border-solid border-gray-300">Kingston 5 Restaurant</span>
                            </div>
                        </div>
                        <div class="bg-white shadow-sm rounded-2xl p-8">
                            <div class="flex items-center gap-2 text-amber-500 transition-all duration-500  ">
                            ...
                            <p class="py-6 text-lg leading-8 text-gray-400">"When we faced a critical moment, preparing to launch a new product and service under tight pressure, there was only one person we knew could deliver — T. Alexander. Having worked with him in the past, we knew his strategic mind and... <span class="font-bold">Read More</span></p>
                            <div class="flex items-center">
                                <div class="flex items-center gap-4">
                                    <img src="https://pagedone.io/asset/uploads/1704351062.png" alt="Wyatt image" class="w-6 h-6 rounded-full object-cover"/>
                                    <h6 class="font-medium text-white">C.E.O</h6>
                                </div>
                                <span class="text-sm font-medium text-yellow-600 ml-4 pl-4 border-l border-solid border-gray-300">Automotive Wrap Professionals
</span>
                            </div>
                        </div>
                    </div>
      ...
      <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-14 text-center">
                <span
                    class="py-1 px-4 bg-yellow-100 rounded-full text-xs font-medium text-yellow-600 text-center">Services</span>
                <h2 class="text-4xl text-center font-bold text-white mt-5">
                    Services Offered
                </h2>
            </div>
            <div
                ...
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    <div class="bg-yellow-50 rounded-lg flex justify-center items-center mb-5 w-20 h-20 mx-auto cursor-pointer transition-all duration-500 group-hover:bg-yellow-600">
                        <svg class="stroke-yellow-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <h4 class="text-lg font-medium text-white mb-3 capitalize">
...
Project Management
                ...
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    <div class="bg-fuchsia-50 rounded-lg flex justify-center items-center mb-5 w-20 h-20 mx-auto cursor-pointer transition-all duration-500 group-hover:bg-fuchsia-600">
                        <svg class="stroke-orange-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M15.4167 12.0833V21.25M5.41667 21.25V20.8333C5.41667 19.262 5.41667 18.4763 5.90482 17.9882C6.39298 17.5 7.17865 17.5 8.75 17.5H22.0833C23.6547 17.5 24.4404 17.5 24.9285 17.9882C25.4167 18.4763 25.4167 19.262 25.4167 20.8333V21.25M15.4167 9.16667C13.8453 9.16667 13.0596 9.16667 12.5715 8.67851C12.0833 8.19036 12.0833 7.40468 12.0833 5.83333C12.0833 4.26198 12.0833 3.47631 12.5715 2.98816C13.0596 2.5 13.8453 2.5 15.4167 2.5C16.988 2.5 17.7737 2.5 18.2618 2.98816C18.75 3.47631 18.75 4.26198 18.75 5.83333C18.75 7.40468 18.75 8.19036 18.2618 8.67851C17.7737 9.16667 16.988 9.16667 15.4167 9.16667ZM7.08333 25.8333C7.08333 26.7538 6.33714 27.5 5.41667 27.5C4.49619 27.5 3.75 26.7538 3.75 25.8333C3.75 24.9129 4.49619 24.1667 5.41667 24.1667C6.33714 24.1667 7.08333 24.9129 7.08333 25.8333ZM17.0833 25.8333C17.0833 26.7538 16.3371 27.5 15.4167 27.5C14.4962 27.5 13.75 26.7538 13.75 25.8333C13.75 24.9129 14.4962 24.1667 15.4167 24.1667C16.3371 24.1667 17.0833 24.9129 17.0833 25.8333ZM27.0833 25.8333C27.0833 26.7538 26.3371 27.5 25.4167 27.5C24.4962 27.5 23.75 26.7538 23.75 25.8333C23.75 24.9129 24.4962 24.1667 25.4167 24.1667C26.3371 24.1667 27.0833 24.9129 27.0833 25.8333Z"
...
const slides2 = ref([
    {
        title: "We are a luxury brand strategy consulting firm where integrity is the ink to our pen.",
        description:
