<template>
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 v-gsap.visible.from="{ opacity: 0, y: 50, stagger: 0.4 }" class="text-white text-center font-manrope text-4xl font-bold leading-10 mb-4">Contact <span class="text-yellow-600">Us</span></h2>
            <p v-gsap.visible.from="{ opacity: 0, y: 50, stagger: 0.4 }" class="text-gray-400 text-center text-base font-normal leading-6 mb-14">Feel free to contact us? submit
                your queries here and we will listen</p>
                ...
                <div class="md:mb-0 mb-5 flex flex-col justify-between">
                    <div class="bg-yellow-600 rounded-2xl p-6 mb-8">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="text-white text-base font-medium leading-6">Call Us Directly At</h4>
                        </div>
                        <h3 v-gsap.visible.animateText.once class="text-white font-manrope 2xl:text-3xl lg:text-2xl text-xl font-bold leading-10 mb-12">
                            470 - 601 - 1911</h3>
                        <button
                            class="w-full h-11 text-white text-center text-sm font-semibold leading-5 rounded-full bg-yellow-500 transition-all duration-700 hover:bg-yellow-700 ">Contact
                            Us</button>
                    </div>
                            ...
                            <div class="w-10 h-10 rounded-lg bg-white flex items-center justify-center mr-4">
                                <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        stroke="#111827" stroke-width="1.6"></path>
                                </svg>
                            </div>
                            <h4 class="text-black text-base font-medium leading-6">Chat With Our Team</h4>
                        </div>
                        <h3 v-gsap.visible.animateText.once
                            class="text-black font-manrope 2xl:text-3xl lg:text-2xl text-xl md:break-words break-normal font-bold leading-10 mb-12">
                            email@upTWo.com</h3>
                        <button
                            class="w-full h-11 text-black text-center text-sm font-semibold leading-5 rounded-full bg-gray-300 group-hover:bg-yellow-500 transition-all duration-700 hover:bg-gray-400 ">Contact
                            Us</button>
                    </div>
                </div>
                <div class="col-span-2 md:p-8 p-5 border border-gray-100 rounded-2xl">
                    <form class="mb-0">
                        <div class="flex items-center relative mb-8">
                            <svg width="24" height="24" class="absolute top-3 mr-2 ml-4" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mb-8">
                            <div class="flex items-center relative">
                                <svg width="24" height="24" class="absolute top-3 mr-2 ml-4" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="#111827" stroke-width="1.5" stroke-linecap="round"></path>
                                </svg>
                                <input type="text"
                                    class="w-full h-12 text-gray-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none shadow-sm pl-12"
                        ...
                        <button type="submit" v-gsap.visible.animateText.once.slow.delay-500   
                            class="w-full h-12 text-white text-center text-base font-semibold leading-6 bg-gray-900 rounded-full shadow transition-all duration-200 hover:bg-gray-700">Send
                            Message</button>
                    </form>
                </div>
            </div>
